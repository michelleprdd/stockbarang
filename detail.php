...
$idbarang = $_GET['idb']; //Get id barang
//Get informasi barang berdasarkan database
$get = mysqli_query($conn,"select * from stock where id barang='$idbarang'");
                                ...
                                <table class="table table-bordered" id="mauexport" width="100%" cellspacing="0"> 
                                  <thead>
                                    ...
                                    <tbody>
                                          ...
                                          <?php
                                       $ambildatamasuk =mysqli_query($conn, "select * from masuk m, stock s where idbarang='$idbarang'");
                                       $i = 1;
